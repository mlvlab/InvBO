...
from invbo.utils.mol_utils.mol_utils import smiles_to_desired_scores
from invbo.utils.mol_utils.selfies_vae.model_positional_unbounded import SELFIESDataset, InfoTransformerVAE
...
from invbo.utils.mol_utils.mol_utils import GUACAMOL_TASK_NAMES
...
class MoleculeObjective(LatentSpaceObjective):
    ...
    def __init__(
        self,
        task_id='pdop',
        path_to_vae_statedict="../invbo/utils/mol_utils/selfies_vae/state_dict/SELFIES-VAE-state-dict.pt",
        xs_to_scores_dict={},
